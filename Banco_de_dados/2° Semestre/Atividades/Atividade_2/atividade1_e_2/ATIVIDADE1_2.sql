...
select CDIMOVEL, CDVENDEDOR, VLPRECO, SGESTADO from IMOVEL
where VLPRECO < 150000 and CDVENDEDOR != 2;

-- Questão 2 - Atividade 2
select CDCOMPRADOR, NMCOMPRADOR, NMENDERECO, SGESTADO from COMPRADOR
...
where NMCOMPRADOR like '%U%';

-- Questão 9 - Atividade 2
select CDIMOVEL, VLOFERTA from OFERTA
where CDIMOVEL = 1 or CDIMOVEL = 2;

-- Questão 10 - Atividade 2
select CDIMOVEL, NMENDEREÇO from IMOVEL 
where CDIMOVEL = 2 or CDIMOVEL = 3
order by NMENDEREÇO asc;

-- Questão 11 - Atividade 2
select CDIMOVEL, VLOFERTA, DTOFERTA from OFERTA
where CDIMOVEL = 2 or CDIMOVEL = 3
and VLOFERTA > 140000
order by DTOFERTA desc;

-- Questão 12 - Atividade 2
select CDIMOVEL, VLPRECO, NRAREAUTIL
from IMOVEL
where VLPRECO 
between 110000 and 200000 
order by NRAREAUTIL desc;